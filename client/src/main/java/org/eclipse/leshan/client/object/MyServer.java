 ...
 */
public class MyServer extends BaseInstanceEnabler {
    ...
    public MyServer(int shortServerId, long lifetime, EnumSet<BindingMode> binding, boolean notifyWhenDisable,
    ...
    public MyServer(int shortServerId, long lifetime) {
